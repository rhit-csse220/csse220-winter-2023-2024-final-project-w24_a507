...
public class Level2Serializer {
	...
	public void generateFile() {
		...
		objects.add(new Barrier(900, 200, 100, 2*height, 0,Color.black)); //long top
	

		
		objects.add(new ElectricBarrier(1300, 210, 150, 2*height, 0, Color.cyan));
		objects.add(new ElectricBarrier(1400, 200+2*height, 50, 2*height, 0, Color.cyan));
